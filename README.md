...
Este proyecto debe desplegarse en una URL pública real de Streamlit Cloud o en otra plataforma de hosting.

URL de referencia para el frontend web:

https://tu-proyecto.streamlit.app

> Si no se ha desplegado todavía, sustituir esta URL por la real al publicar la app. Esta referencia está aquí para no perderla.
