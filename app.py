...
# URL pública de referencia para el despliegue en Streamlit.
# Cambiar por la URL real cuando se publique la app en Streamlit Cloud.
STREAMLIT_PUBLIC_URL = "https://tu-proyecto.streamlit.app"
REFERENCE_URL_NOTE = (
    "URL pública de referencia del frontend en Streamlit: "
    f"{STREAMLIT_PUBLIC_URL}." 
    " Sustituir esta valor por la URL real al hacer el despliegue final."
)
